...
VALUES (
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 27 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 27 DAY),
            ' 08:45:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 26 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 26 DAY),
            ' 08:50:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 23 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 23 DAY),
            ' 08:50:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 22 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 22 DAY),
            ' 08:55:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 19 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 19 DAY),
            ' 08:50:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 18 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 18 DAY),
            ' 09:05:00'
        ),
    ...
    (
        DATE_SUB(CURRENT_DATE, INTERVAL 17 DAY),
        CONCAT(
            DATE_SUB(CURRENT_DATE, INTERVAL 17 DAY),
            ' 08:50:00'
        ),
